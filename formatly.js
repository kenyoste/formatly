    ...
    formatlyElements.forEach(el => {
      ...
      logoWrapper.innerHTML = `
        <svg width="32" height="32" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="15" y="25" width="70" height="70" rx="18" stroke="black" stroke-width="7" fill="none"/>
          <path d="M55 80 L95 40" stroke="black" stroke-width="7" stroke-linecap="round"/>
          <circle cx="98" cy="37" r="5" fill="none" stroke="black" stroke-width="7"/>
          <rect x="85" y="27" width="15" height="15" rx="4" transform="rotate(45 92.5 34.5)" stroke="black" stroke-width="7" fill="none"/>
        </svg>
      `;
